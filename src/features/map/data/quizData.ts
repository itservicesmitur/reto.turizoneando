...
export const STOP_QUIZ_DATA: StopQuizData[] = [
  // 0 — Alcázar de Colón
  {
    ...
    questions: [
      {
        text: '¿Entre qué años fue construido el Alcázar de Colón?',
        options: ['1492 – 1498', '1511 – 1514', '1520 – 1530', '1503 – 1508'],
        correctIndex: 1,
      },
      {
        text: '¿Quién mandó construir el Alcázar de Colón?',
  ...
  // 1 — Plaza de España
  {
    ...
    questions: [
      {
        text: '¿Cuántas horas al día está abierta la Plaza de España?',
        options: ['12 horas', '18 horas', '24 horas', '8 horas'],
        correctIndex: 2,
      },
      {
        text: '¿Qué edificio histórico domina la vista desde la Plaza de España?',
  ...
  // 2 — Fortaleza Ozama
  {
    ...
    questions: [
      {
        text: '¿En qué año fue construida la Fortaleza Ozama?',
        options: ['1492', '1502', '1515', '1498'],
        correctIndex: 1,
      },
      {
        text: '¿Cuál fue el propósito original de la Fortaleza Ozama?',
  ...
  // 3 — Calle Las Damas
  {
    ...
    questions: [
      {
        text: '¿Por qué se llama "Calle Las Damas"?',
      ...
      {
        text: '¿Qué distinción histórica tiene la Calle Las Damas?',
  ...
  // 4 — Museo de las Casas Reales
  {
    ...
    questions: [
      {
        text: '¿Qué institución colonial funcionó en el Museo de las Casas Reales?',
        options: ['La primera universidad', 'La Real Audiencia y Palacio de los Gobernadores', 'El primer hospital', 'La Casa de la Moneda'],
        correctIndex: 1,
      },
      {
        text: '¿Cuánto cuesta la entrada al Museo de las Casas Reales?',
  ...
  // 5 — Reloj de Sol
  {
    ...
    questions: [
      {
        text: '¿En qué año fue construido el Reloj de Sol de la Zona Colonial?',
        options: ['1700', '1753', '1800', '1650'],
        correctIndex: 1,
      },
      {
        text: '¿Durante la gobernación de quién fue construido el Reloj de Sol?',
  ...
  // 6 — Panteón Nacional
  {
    ...
    questions: [
      {
        text: '¿Qué era el Panteón Nacional antes de convertirse en mausoleo?',
        options: ['Un palacio colonial', 'Una iglesia jesuita', 'Una fortaleza', 'Un convento franciscano'],
        correctIndex: 1,
      },
      {
        text: '¿Qué tipo de personajes descansan en el Panteón Nacional?',
  ...
  // 7 — Catedral Primada de América
  {
    ...
    questions: [
      {
        text: '¿Por qué el Papa Julio II consagró la Catedral Primada de América?',
        options: ['Por ser la más grande', 'Por ser la más antigua de las Américas', 'Por ser la más costosa', 'Por ser la más alta'],
        correctIndex: 1,
      },
      {
        text: '¿En qué año fue consagrada la Catedral Primada de América?',
  ...
  // 8 — Parque Colón
  {
    ...
    questions: [
      {
        text: '¿Qué es lo más emblemático del Parque Colón?',
        options: ['Una fuente colonial', 'La estatua de Cristóbal Colón', 'Un árbol centenario', 'Un teatro histórico'],
        correctIndex: 1,
      },
      {
        text: '¿Qué función cumple el Parque Colón en la Zona Colonial?',
  ...
  // 9 — Ruinas de San Francisco
  {
    ...
    questions: [
      {
        text: '¿En qué año fue construido el Monasterio de San Francisco?',
        options: ['1492', '1508', '1520', '1500'],
        correctIndex: 1,
      },
      {
        text: '¿A qué orden religiosa pertenecía el Monasterio de San Francisco?',
  ...
  // 10 — Puerta de la Misericordia
  {
    ...
    questions: [
      {
        text: '¿Qué evento histórico ocurrió en la Puerta de la Misericordia?',
      ...
      {
        text: '¿En qué año se proclamó la Independencia en la Puerta de la Misericordia?',
  ...
  // 11 — Puerta del Conde
  {
    ...
    questions: [
      {
        text: '¿Qué importancia tiene la Puerta del Conde en la historia dominicana?',
      ...
      {
        text: '¿Qué tipo de estructura es la Puerta del Conde?',
